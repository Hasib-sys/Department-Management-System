...
?> 
        ...
        <div class="col-md-3 col-sm-6 col-xs-12">
          <div class="info-box">
            ...
            <div class="info-box-content">
              <span class="info-box-text">Club Monthly Income</span>
<?php
include_once('../controller/config.php');
$current_year=date("Y");
...
?>             
              ...
              <span class="info-box-number"><small>Tk</small><?php echo $monthly_income; ?></span>
            </div>
            <!-- /.info-box-content -->
          </div>
          <!-- /.info-box -->
...
?>             
              ...
              <span class="info-box-number"><small>Tk</small><?php echo $total_income; ?></span>
            </div>
            <!-- /.info-box-content -->
          </div>
          <!-- /.info-box -->
