                	...
                	<form role="form" action="../index.php" method="post" id="form1">                    
                  		<div class="box-body">
                    		<div class="form-group" id="divGrade">
                      			...
                      			<input type="text" class="form-control" id="name" placeholder="Enter Batch" name="name" autocomplete="off">
                    		</div>
                    ...
                    <div class="col-md-3">
                        <div class="panel panel-primary">
                            <div class="panel-heading">               
                                ...
                                <h3 class="panel-title">Add CLub Range & Grade</h3>
                            </div>
...
//MSK-000098-form submit
	...
	if(admission_fee == ''){
		...
		$('#divAdmissionFee').append('<span id="spanAdmissionFee" class="glyphicon glyphicon-remove form-control-feedback set-width-tooltip" data-toggle="tooltip"    title="The Club Fee is required" ></span>');	
			...
			<div class="col-md-7">
            	<div class="box">
                	<div class="box-header">
                  		<h3 class="box-title">All Batches Payment Summery</h3>
                	</div><!-- /.box-header -->
           			...
           			<div class="col-md-6">
                		<div class="panel">
        					<div class="panel-heading bg-orange">              
        						<button type="button" class="close" data-dismiss="modal" aria-hidden="true"><span class="glyphicon glyphicon-remove" aria-hidden="true"></span></button>
          						<h4 class="modal-title custom_align" id="Heading">Edit Batch</h4>
   							</div>
                            <div class="panel-body"> <!-- Start of modal body--> 
                                ...
                                <div class="form-group" id="divHChargeUpdate">
                                    <label for="">Semester Fees(Tk)</label>
...
//MSK-000108
	...
	if(admission_fee1 == ''){
		...
		$('#divAFeeUpdate').append('<span id="spanAFeeUpdate" class="glyphicon glyphicon-remove form-control-feedback set-width-tooltip" data-toggle="tooltip"    title="The Club Fee is required" ></span>');	
